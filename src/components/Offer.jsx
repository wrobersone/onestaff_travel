...
export default function Offer() {
    const data = [
        {
            text: 'Best Travel Guide Always for Travelers',
            icon: <BsPerson />,
            color: 'red',
        },
        {
            text: 'World Class Services Provided',
            icon: <BiWorld />,
            color: 'green',
        },
        {
  ...
  return (
    <Section id='offer'>
        ...
        <div className="content">
            <div className="title">
                <h1>We are offering 800+ tours across the world</h1>
            </div>
            <ul className="list">
                {
    ...
    .content {
        ...
        .list {
            ...
            li {
                ...
                .green {
                    background-color: #65ce54aa;
                    color: #65ce54;
                }
                .yellow {
                    background-color: #ffc01eaa;
                    color: #ffc01e;
                }
            }
        }
